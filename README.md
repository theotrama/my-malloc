...
<figure id="figure-1">
  <img src="diagrams/implicit_free_list.svg" alt="Basic implicit free list">
...
<figure id="figure-2">
  <img src="diagrams/implicit_free_list-state-1.svg" alt="implicit free list">
...
<figure id="figure-3">
  <img src="diagrams/implicit_free_list-state-2.svg" alt="implicit free list">
...
<figure id="figure-4">
  <img src="diagrams/implicit_free_list-edge-cases.svg" alt="implicit free list edge cases">
...
<figure id="figure-5">
  <img src="diagrams/implicit_free_list-request-memory.svg" alt="Request more memory from the OS">
...
<figure id="figure-7">
  <img src="diagrams/explicit_free_list-case-1.svg" alt="A more complex explicit free list">
...
<figure id="figure-8">
  <img src="diagrams/explicit_free_list-malloc.svg" alt="Removing an element from the free list">
...
<figure id="figure-9">
  <img src="diagrams/explicit_free_list-case-1.svg" alt="Case 1 - previous and next blocks are allocated">
...
<figure id="figure-10">
  <img src="diagrams/explicit_free_list-case-2.svg" alt="Case 2 - previous block free and next block allocated">
...
<figure id="figure-11">
  <img src="diagrams/explicit_free_list-case-3.svg" alt="Case 3 - previous block allocated and next block free">
...
<figure id="figure-12">
  <img src="diagrams/explicit_free_list-case-4.svg" alt="Case 4 - previous and next blocks free">
